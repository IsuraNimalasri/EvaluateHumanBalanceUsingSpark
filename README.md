...
```
docker exec -it evaluatehumanbalanceusingspark_redis_1 redis-cli
```
...
```
docker exec -it evaluatehumanbalanceusingspark_kafka_1 kafka-console-consumer --bootstrap-server localhost:9092 --topic redis-server
```
...
```
docker logs evaluatehumanbalanceusingspark_spark_1 >& spark/logs/spark-master.log

docker logs evaluatehumanbalanceusingspark_spark_1 >& spark/logs/spark-master.log >& ../../spark/logs/spark-worker.log
```
...
```
docker logs -f evaluatehumanbalanceusingspark_stedi_1
```
